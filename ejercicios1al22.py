...
while name != '0': 
    ...
    name = input('Que Ejercicio desea ver? (1 al 22), 0 para salir \n')
    ...
    if name == '1' :
        ...
        C = 0
        print('Ejercicio1 \n')
        print('Consigna: Algoritmo que intercambie los valores de A y B y muestre cuo¡nto valen al final las dos variables  \n')
    ...
    # Ejercicio 2
        ...
        print ('Ejercicio2 \n')
        print('Consigna: Algoritmo que lea dos noºmeros, Calculando... y escribiendo el valor de su suma, resta,producto y divisio³n  \n')
        #limpiamos las variables
        A = 0
        B = 0
        C = 0
    ...
    # Ejercicio 3
        ...
        print ('Ejercicio3 \n')
        print('Consigna: Calcular Porcentaje de Ninos y de Ninas  \n')
        #limpiamos las variables
        Ninios = 0
        Ninias = 0
        Total = 0
        ...
        Ninios = input('Ingrese Cantidad de Ninos  ')
        Ninias = input('Ingrese Cantidad de Ninas  ')
        Ninios = int (Ninios)
        Ninias = int (Ninias)
        print('Calculando...')
        Total = Ninios + Ninias
        ...
        print('Resultados \n')
        print('El Total de Ninos es %s' % Total)
    ...
    # Ejercicio 9
        ...
        Segundos = 0
        #Entrada de datos y conversion a Float
        Dias = input('Ingrese Cantidad de Do­as:  ')
        Dias = int (Dias)
        print('Calculando...')
        Horas = Dias * 24
        Minutos = Horas * 60
    ...
    # Ejercicio 12
        ...
        Porcentaje = 0
        #Entrada de datos y conversion a Float
        Precio1 = input('Ingrese el precio a Principio de Ano:  ')
        Precio2 = input('Ingrese el precio a Final de Ano:  ')
        ...
        print('Resultados \n')
        print('La variacion de precio es del {0:.2f} %'.format(Porcentaje))    
    ...
    # Ejercicio 15
        ...
        if (Caracter < 'N'):
            ...
            print('El Caracter no es vo¡lido')
    ...
    # Ejercicio 21
        ...
        print('Ingrese la Condicion de Contratacion  \n')
        print('1 ) Salario Fijo + Comision  \n')
    ...
    # Preguntar Nuevamente por entrada no valida
        ...
        print ('Ingrese un numero del 1 al 22, usted ingreso %s , intente nuevamente' % name)
        name = input('Que Ejercicio desea ver? (1 al 22), 0 para salir \n')
